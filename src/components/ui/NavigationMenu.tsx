...
export function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      className={cn(
        'left-0 top-0 w-full rounded-3xl border border-black/[0.06] dark:border-white/[0.04] bg-white/95 dark:bg-[#131318]/95 backdrop-blur-2xl p-4 shadow-[0_18px_40px_-10px_rgba(0,0,0,0.5)] data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out',
        className
      )}
      {...props}
    />
  ...
  return (
    <div className={cn('absolute left-0 top-full flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          'relative mt-2 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-3xl border border-black/[0.06] dark:border-white/[0.04] bg-white/95 dark:bg-[#131318]/95 backdrop-blur-2xl shadow-[0_18px_40px_-10px_rgba(0,0,0,0.5)] origin-top-center',
