    ...
    <div className="flex flex-col gap-1.5 w-full">
      ...
      {showStrength && val.length > 0 && (
        <div className="flex flex-col gap-2 pt-1">
          <div className="w-full h-1 bg-zinc-200 dark:bg-white/[0.06] rounded-full overflow-hidden">
            <div
            ...
            {rules.map((rule) => (
              <div key={rule.id} className="flex items-center gap-1.5 text-[11px]">
                {rule.met ? (
                  ...
                  <div className="w-1.5 h-1.5 rounded-full bg-zinc-400 dark:bg-zinc-600 ml-1 mr-0.5 shrink-0" />
                )}
