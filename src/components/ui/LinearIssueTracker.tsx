    ...
    <div className="space-y-4">
            ...
            {(['ALL', 'ACTIVE', 'DONE', 'URGENT'] as const).map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer select-none ${
                    isActive
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1 rounded-full text-zinc-400 hover:text-zinc-700 dark:hover:text-white cursor-pointer"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
      ...
      <AnimatePresence>
        {selectedIssueIds.length > 0 && (
          ...
          >
            <div className="liquid-glass-dark-dock px-4 py-2 rounded-full flex items-center gap-2.5 shadow-2xl border border-white/[0.08] backdrop-blur-2xl">
              <span className="text-xs font-mono font-bold text-white px-2 py-0.5 rounded-full bg-white/[0.1]">
              ...
              <button
                ...
                className="p-1.5 rounded-full text-rose-400 hover:bg-rose-500/20 transition-colors cursor-pointer"
