    ...
    >
      <div className="pointer-events-auto flex items-center justify-center gap-1.5 w-full max-w-[380px] mx-auto">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className="group relative flex-1 min-h-[44px] py-1.5 px-1 rounded-full cursor-pointer flex flex-col items-center justify-center transition-all duration-150 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-1 focus-visible:ring-offset-transparent"
        ...
        <button
          ...
          className={`relative min-w-[44px] min-h-[44px] w-10 h-10 rounded-full active:scale-95 flex items-center justify-center transition-all duration-150 cursor-pointer shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 ${
            isDark
