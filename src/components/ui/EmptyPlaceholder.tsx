  ...
  return (
    <div
      className={cn(
        ...
        'border border-dashed border-black/10 dark:border-white/[0.06] bg-zinc-50/50 dark:bg-[#0B0C11]/50',
        'w-full max-w-lg mx-auto',
        className
      )}
    >
      <div className="w-12 h-12 rounded-2xl bg-white dark:bg-[#131318] border border-black/5 dark:border-white/5 flex items-center justify-center text-zinc-400 dark:text-zinc-500 shadow-xs mb-4">
