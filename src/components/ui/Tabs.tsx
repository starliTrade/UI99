...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center p-1 rounded-2xl bg-zinc-100/90 dark:bg-[#121217] text-(--text-secondary) border border-black/[0.04] dark:border-white/[0.04]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'mt-3 focus-visible:outline-none focus-ui99-inset',
      className
    )}
    {...props}
  />
