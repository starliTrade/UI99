    ...
    <div className={cn('flex items-center', className)} aria-label={`${names.length} members`}>
      ...
      {overflow > 0 && (
        <div className="-ml-2" style={{ zIndex: 0 }}>
          <div
            className={cn(
              'flex items-center justify-center rounded-(--radius-pill) bg-(--bg-subtle) dark:bg-(--bg-card-hover) font-mono font-semibold text-(--text-secondary) ring-2 ring-white dark:ring-(--bg-card)',
