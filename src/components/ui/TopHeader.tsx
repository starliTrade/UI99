    ...
    <header className="sticky top-0 z-50 w-full bg-transparent border-none shadow-none select-none transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="relative flex items-center justify-center w-8 h-8 rounded-xl bg-zinc-900 dark:bg-[#0E0F16] border border-black/10 dark:border-white/[0.06] shadow-[0_2px_8px_rgba(0,0,0,0.1)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_4px_12px_rgba(0,0,0,0.5)] overflow-hidden transition-all group-hover:border-emerald-500/40 dark:group-hover:border-emerald-400/40">
          ...
          <div className="flex items-center gap-1.5 font-['Inter',_'Plus_Jakarta_Sans',_sans-serif]">
            <div className="flex items-center text-[15px] sm:text-[16px] tracking-[-0.03em] leading-none select-none">
              <span className="font-bold text-zinc-950 dark:text-[#EDEDEF] transition-colors">
                UI
              </span>
              ...
              <span className="inline-flex items-center text-zinc-800 dark:text-zinc-200">
                ...
                <span className="px-0.5 font-bold text-zinc-950 dark:text-[#EDEDEF]">
                  99
                </span>
                <span className="text-zinc-400 dark:text-zinc-600 font-light">]</span>
              </span>
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.div
                  ...
                  className="absolute end-0 mt-2 w-56 rounded-2xl p-2 z-50 backdrop-blur-2xl bg-white/95 dark:bg-[#0C0D12]/95 text-zinc-900 dark:text-white shadow-[0_16px_36px_rgba(0,0,0,0.12)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04),0_20px_48px_rgba(0,0,0,0.85)] border border-zinc-200 dark:border-white/[0.03]"
                >
                  <div className="p-1.5 mb-1">
                    ...
                    <div className="grid grid-cols-2 p-0.5 rounded-xl bg-zinc-100 dark:bg-[#07080B] border border-zinc-200/60 dark:border-white/[0.03]">
                      <button
                        type="button"
