  ...
  return (
    <div className={`w-full space-y-2 select-none ${className}`}>
      <div className="relative w-full h-5 flex items-center">
        ...
        <div
          className="absolute w-4 h-4 rounded-(--radius-pill) bg-white shadow-md border border-(--border-strong) dark:border-white/20 pointer-events-none -translate-x-1/2"
