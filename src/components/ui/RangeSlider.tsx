  ...
  return (
    <div className={`w-full space-y-2 select-none ${className}`}>
      <div className="relative w-full h-5 flex items-center">
        {/* Track */}
        <div className="w-full h-1.5 rounded-(--radius-pill) bg-zinc-200 dark:bg-white/[0.06] relative">
          {/* Highlight Range */}
          <div
        ...
        <div
          className="absolute w-4 h-4 rounded-(--radius-pill) bg-white shadow-md border border-zinc-300 dark:border-white/20 pointer-events-none -translate-x-1/2"
