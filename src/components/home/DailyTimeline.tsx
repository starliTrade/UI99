              ...
              <React.Fragment key={item.id}>
                ...
                >
                  ...
                  <div className="px-2 shrink-0">
                    {item.isCompleted ? (
                      <div className="w-4 h-4 rounded-full bg-emerald-500/15 text-emerald-400 flex items-center justify-center border border-emerald-500/25">
                        <Check className="w-2.5 h-2.5 stroke-[2.5]" />
                      </div>
                    ) : (
                      <div className="w-4 h-4 rounded-full flex items-center justify-center border border-white/15 bg-white/[0.02]">
