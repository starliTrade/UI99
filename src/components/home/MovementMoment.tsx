...
export function MovementMoment({
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 rounded-(var(--radius-control)) bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400">
  ...
  return (
    ...
    >
      {/* Warm Ambient Aura */}
      <div className="absolute top-0 right-0 w-44 h-44 bg-orange-500/[0.06] rounded-(var(--radius-pill)) blur-3xl pointer-events-none" />

      {/* Header */}
      <div className="flex items-center justify-between mb-3.5 relative z-10">
        <div className="flex items-center gap-2">
          <span className="flex items-center justify-center w-5 h-5 rounded-(var(--radius-pill)) bg-orange-500/15 text-orange-400">
      ...
      <div className="flex items-center justify-between gap-4 relative z-10">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 rounded-(var(--radius-pill)) bg-orange-500/15 hover:bg-orange-500/25 text-orange-300 border border-orange-500/25 shrink-0 transition-transform active:scale-95 cursor-pointer shadow-(var(--glow-warning-md))"
        >
          <Flame className="w-3.5 h-3.5 fill-current" />
