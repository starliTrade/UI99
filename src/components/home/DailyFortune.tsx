...
export function DailyFortune() {
  ...
  return (
    <div
      ...
      className="group relative p-5 sm:p-6 rounded-(--radius-xl) cursor-pointer overflow-hidden transition-all duration-300 bg-[#090A0F] border border-white/[0.03] shadow-(--shadow-card-hover) hover:border-white/[0.06] select-none"
    >
      ...
      <div className="flex items-center justify-between mb-3 relative z-10">
        <div className="flex items-center gap-2">
          <span className="flex items-center justify-center w-6 h-6 rounded-(--radius-pill) bg-violet-500/15 text-violet-300 border border-violet-500/20 text-xs">
            {fortune.symbol}
          </span>
        ...
        <div className="flex items-center gap-2">
          <span className="text-[9px] uppercase tracking-wider px-2 py-0.5 rounded-(--radius-pill) bg-white/[0.04] text-[#92929B] border border-white/[0.04]">
