          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div
                className={`h-20 rounded-(--radius-control) flex items-end p-3 mb-3 border ${
                  isDark
                    ? 'bg-[#0E0E14] border-white/[0.06] shadow-(--rim-soft)'
            ...
            >
              <div
                className={`h-20 rounded-(--radius-control) flex items-end p-3 mb-3 border ${
                  isDark
                    ? 'bg-[#131318] border-white/[0.07] shadow-(--shadow-card)'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
              {[
                ...
                <div
                  ...
                  className="p-4 rounded-(--radius-control) bg-zinc-50 dark:bg-[#0E0E14] border border-black/[0.04] dark:border-white/[0.03] hover:border-black/[0.15] dark:hover:border-white/[0.08] cursor-pointer transition-all active:scale-98"
                >
    ...
    <UI99Provider theme="dark">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-4 sm:p-6 rounded-(--radius-control) sm:rounded-(--radius-lg) bg-white dark:bg-[#0B0C11] border border-black/[0.05] dark:border-white/[0.03] shadow-xs space-y-3 flex flex-col justify-center">
            <EmptyPlaceholder
  ...
  StatusBadge
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 flex flex-col gap-4">
              <div
                className="p-8 rounded-(--radius-lg) bg-zinc-50 dark:bg-[#0E0E14] border border-black/[0.05] dark:border-white/[0.04] flex items-center justify-center min-h-[170px] relative overflow-hidden"
                style={{
      ...
      <div className="fixed bottom-20 right-4 sm:right-6 z-dock pointer-events-auto">
        <button
          ...
          className="h-10 w-10 rounded-(--radius-pill) flex items-center justify-center bg-white/90 dark:bg-[#0E0E14]/90 text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white border border-zinc-200/80 dark:border-white/[0.06] shadow-(--elevation-2) dark:shadow-(--elevation-3) backdrop-blur-xl transition-all active:scale-95 cursor-pointer hover:border-emerald-500/40"
