    ...
    <div className="w-full pb-16 px-0 sm:px-1 max-w-6xl mx-auto text-zinc-900 dark:text-white select-none transition-colors">
      ...
      <section className="relative flex flex-col items-start pb-6 sm:pb-10 overflow-visible">
        ...
        >
          <div
            aria-hidden="true"
            className="absolute -inset-2 rounded-2xl bg-emerald-500/[0.03] dark:bg-emerald-400/[0.03] blur-xl pointer-events-none -z-10"
          />
          ...
          <div className="h-9 inline-flex items-center justify-between gap-2.5 pl-3 pr-1.5 rounded-xl bg-zinc-100 dark:bg-[#0A0B10] border border-zinc-200/80 dark:border-white/[0.035] shadow-(var(--rim-soft), var(--elevation-1)) text-xs font-mono text-zinc-800 dark:text-zinc-200 whitespace-nowrap">
            ...
            <button
              ...
              className="p-1 rounded-lg hover:bg-zinc-200 dark:hover:bg-white/[0.06] text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white transition-colors cursor-pointer shrink-0 ml-1"
            >
              {copiedKey === 'cli-init' ? (
        ...
        <div className="mt-4 sm:mt-8 rounded-2xl sm:rounded-3xl border border-zinc-200/60 dark:border-white/[0.03] bg-white dark:bg-[#0C0D12] shadow-(var(--elevation-3)) dark:shadow-(var(--elevation-4)) overflow-hidden transition-all">
          ...
          <div className="px-3 sm:px-4 py-2.5 sm:py-3 border-b border-zinc-200/50 dark:border-white/[0.03] bg-zinc-50/70 dark:bg-[#090A0E] flex items-center justify-between gap-2 sm:gap-4 flex-nowrap min-w-0">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              <div className="flex items-center gap-0.5 p-0.5 rounded-xl bg-zinc-200/50 dark:bg-[#111218] border border-zinc-300/40 dark:border-white/[0.03]">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 rounded-lg text-xs font-mono transition-all cursor-pointer ${
                      studioView === v.id
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-xl text-xs font-mono text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-200/50 dark:hover:bg-white/[0.05] transition-colors cursor-pointer shrink-0"
              >
                <span>Full API</span>
            ...
            <div className="px-3 sm:px-4 pt-2.5 pb-1.5 flex items-center gap-1.5 overflow-x-auto no-scrollbar touch-pan-x">
              {categories.map((cat) => (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-mono whitespace-nowrap transition-all cursor-pointer ${
            ...
            <div className="px-3 sm:px-4 py-2 border-t border-zinc-200/40 dark:border-white/[0.02] flex items-center gap-2 overflow-x-auto no-scrollbar touch-pan-x">
              ...
              <div className="relative shrink-0 w-32 xs:w-40 sm:w-48">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-2.5 py-1 rounded-lg bg-white dark:bg-white/[0.03] border border-zinc-200/60 dark:border-white/[0.04] text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:border-zinc-400 dark:focus:border-white/20 font-mono"
                />
              </div>
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {filteredComponents.map((c) => (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-mono whitespace-nowrap transition-all cursor-pointer border min-h-[30px] sm:min-h-[32px] ${
          ...
          <div className="p-3 sm:p-6 md:p-8 bg-white dark:bg-[#0C0D12]">
            ...
            {studioView === 'stage' && (
              <div className="flex-1 flex flex-col justify-between gap-3 sm:gap-4">
                ...
                <div className="relative min-h-[220px] sm:min-h-[290px] rounded-2xl bg-zinc-50/80 dark:bg-[#060709] border border-zinc-200/80 dark:border-white/[0.025] p-4 sm:p-8 flex items-center justify-center overflow-hidden">
                  <div
                    aria-hidden="true"
                  ...
                  <div className="relative z-10 w-full max-w-lg flex items-center justify-center">
                    ...
                    {activeComponentId === 'copy-button' && (
                      <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-100 dark:bg-[#0A0B10] border border-zinc-200 dark:border-white/[0.04]">
                    ...
                    {activeComponentId === 'sparkline' && (
                      <div className="w-full p-4 rounded-2xl bg-zinc-100 dark:bg-[#090A0E] border border-zinc-200 dark:border-white/[0.04] space-y-2">
                    ...
                    {![
                      ...
                      <div className="w-full p-6 rounded-2xl bg-zinc-100/70 dark:bg-[#08090D] border border-zinc-200/80 dark:border-white/[0.04] text-center space-y-3">
                        ...
                        <div className="flex items-center justify-center gap-2 pt-2">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 text-xs font-mono font-bold cursor-pointer hover:opacity-90 transition-opacity inline-flex items-center gap-1.5"
                          >
                ...
                <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-zinc-50/90 dark:bg-[#08090D] border border-zinc-200/80 dark:border-white/[0.03] overflow-hidden">
                          ...
                          <div className="flex items-center gap-1 overflow-x-auto no-scrollbar touch-pan-x py-0.5">
                            {(['primary', 'secondary', 'outline', 'ghost', 'rose'] as const).map((v) => (
                              <button
                                ...
                                className={`px-2 py-0.5 rounded-md capitalize font-mono text-[11px] whitespace-nowrap cursor-pointer transition-colors shrink-0 ${
                                  btnVariant === v
                          ...
                          <div className="flex items-center gap-1 overflow-x-auto no-scrollbar touch-pan-x py-0.5">
                            {(['xs', 'sm', 'md', 'lg'] as const).map((s) => (
                              <button
                                ...
                                className={`px-2 py-0.5 rounded-md uppercase font-mono text-[10px] cursor-pointer transition-colors shrink-0 ${
                                  btnSize === s
                                    ? 'bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 font-bold'
                                    : 'text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white bg-zinc-200/50 dark:bg-white/[0.03]'
                                }`}
                  ...
                  <div className="flex items-center gap-1.5 min-w-0 w-full lg:w-auto shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-zinc-200/60 dark:border-white/[0.03]">
                    {/* PM Quick Pills */}
                    <div className="flex items-center p-0.5 rounded-lg bg-zinc-200/70 dark:bg-white/[0.04] border border-zinc-300/60 dark:border-white/[0.03] shrink-0">
            ...
            {studioView === 'cli' && (
              <div className="space-y-3">
                <div className="p-3 sm:p-4 rounded-2xl bg-zinc-50/70 dark:bg-[#06070A] border border-zinc-200/50 dark:border-white/[0.06] space-y-2.5">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex items-center p-0.5 rounded-lg bg-zinc-200/50 dark:bg-white/[0.06] border border-zinc-300/40 dark:border-white/[0.04] shrink-0">
                      {(['npm', 'pnpm', 'bun', 'yarn'] as const).map((pm) => (
                        <button
                          key={pm}
                          type="button"
                  ...
                  <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 rounded-xl bg-zinc-900 dark:bg-[#090A0F] font-mono text-xs text-emerald-400 border border-zinc-800 dark:border-white/[0.04] min-w-0 overflow-hidden">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-zinc-800 dark:hover:bg-white/[0.08] text-zinc-400 hover:text-white transition-colors cursor-pointer shrink-0"
                    >
                ...
                <div className="p-3 sm:p-4 rounded-2xl bg-zinc-50/70 dark:bg-[#06070A] border border-zinc-200/50 dark:border-white/[0.06] space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-zinc-200 dark:hover:bg-white/[0.08] text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white transition-colors cursor-pointer shrink-0"
                    >
                  ...
                  <div className="p-2.5 sm:p-3 rounded-xl bg-zinc-900 dark:bg-[#090A0F] font-mono text-[11px] sm:text-xs text-zinc-200 border border-zinc-800 dark:border-white/[0.04] overflow-x-auto no-scrollbar whitespace-nowrap">
            ...
            {studioView === 'tokens' && (
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-zinc-50/80 dark:bg-[#08090D] border border-zinc-200/80 dark:border-white/[0.04] space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono">
                    <div className="p-2.5 rounded-xl bg-white dark:bg-[#0D0E14] border border-zinc-200/60 dark:border-white/[0.03]">
